...
#/**
# * RV. Productions Bootloader Theme Installer
# *
# * @license MIT
# * @author  "Rick Veenstra"
# * @version 1.0.0
# */
...
function config_grub() {
    ...
    echo_primary 'Setting grub timeout to 20 seconds'
...
function main() {
    splash 'RV. Productions Bootloader Themes'
    ...
    echo_success 'RV. Productions Bootloader Theme Update Successful!'
}
